...
import com.delirium.playlistmaker.player.data.db.SongPlaylistDao
import com.delirium.playlistmaker.search.data.db.SongDao

@Database(version = 1, entities = [SongEntity::class, FavoriteSongEntity::class, PlayListEntity::class, SongPlaylistEntity::class])
